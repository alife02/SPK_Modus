<?php $__env->startSection('content'); ?>
    <div id="page-wrapper" class="sign-in-wrapper">
        <div class="graphs">
            <div class="sign-up">
                <form action="<?php echo e(url('settings/user/'.$user->id)); ?>" method="POST">
                    ...
                    <div class=" sign-u<?php echo e($errors->has('first_name') ? ' has-error' : ''); ?>">
                        ...
                        <div class="sign-up2">
                            <input id="fname" type="text" name="first_name" value="<?php echo e(old('first_name', $user->first_name)); ?>"/>
                    ...
                    <div class="sign-u<?php echo e($errors->has('last_name') ? ' has-error' : ''); ?>">
                        ...
                        <div class="sign-up2">
                            <input id="lname" type="text" name="last_name" value="<?php echo e(old('last_name', $user->last_name)); ?>"/>
                    ...
                    <div class="sign-u<?php echo e($errors->has('oldPassword') ? ' has-error' : ''); ?>">
                        <div class="sign-up1">
                            <h4>Old Password* :</h4>
                        </div>
                        <div class="sign-up2">
