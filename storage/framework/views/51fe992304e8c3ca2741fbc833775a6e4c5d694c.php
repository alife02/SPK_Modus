...
<head>
    ...
    <!-- Bootstrap Core CSS -->
<?php /*    <link href="<?php echo e(asset('css/bootstrap.min.css')); ?>" rel='stylesheet' type='text/css'/>*/ ?>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            <?php if(\Auth::user()->status == "admin"): ?>
                <?php echo $__env->make('layouts._nav_admin', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php else: ?>
                <?php echo $__env->make('layouts._nav_employee', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php endif; ?>
        </div>
    </div>
    <!-- left side end-->
                    ...
                    <div class="profile_details_left">
                        <ul class="nofitications-dropdown">
                            ...
                            <li class="login_box" id="loginContainer">
                                ...
                                <script src="<?php echo e(asset('js/uisearch.js')); ?>"></script>
                                <script>
                            ...
                            <li class="dropdown profile_details_drop">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <div class="profile_img">
                                        <?php if(Auth::user()->status == "admin"): ?>
                                            <span style="background:url(<?php echo e(asset('images/a-logoprof.jpg')); ?>) no-repeat center"> </span>
                                            <div class="user-name">
                                                <p><?php echo e(Auth::user()->first_name); ?><span>Admin</span></p>
                                            </div>
                                        <?php else: ?>
                                            <span style="background:url(images/e-logoprof.jpg) no-repeat center"> </span>
                                            <div class="user-name">
                                                <p><?php echo e(Auth::user()->first_name); ?><span>Employee</span></p>
                                            </div>
                                        <?php endif; ?>
                                ...
                                <ul class="dropdown-menu drp-mnu">
                                    <?php if(Auth::user()->status == "admin"): ?>
                                        <li><a href="<?php echo e(url('/admin/settings')); ?>"><i class="fa fa-cog"></i> Settings</a></li>
